<template>
   <div class="single-manga-container">
          ...
          <div class="flex items-center">
            ...
            <div class="btn d-flex">
              ...
              <div class="update-section ml-4">
                <small class="update-text">Want to Update this book? <button data-modal-target="defaultModal" data-modal-toggle="defaultModal" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" @click="handleUpdate">Update</button>
                </small>
              </div>
    ...
    <Modal v-show="openModal" @close-modal="openModal = false"/>
   </div>
</template>
<script>
